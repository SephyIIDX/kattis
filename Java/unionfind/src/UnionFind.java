...
public class UnionFind {
    ...
    /**
     * Joins the set containing <i>a</i> with the set containing <i>b</i> by
     * appending<br>
     * the set with lower rank to the one with higher rank. <br>
     * <br>
     * 
     * If both ranks are the same the set containing <i>b</i> is appended to the
     * <br>
     * set containing <i>a</i> and the rank of set containing <i>a</i> is increased
     * by 1.
     * 
     * @param a member of a set to be joined
     * @param b member of a set to be joined
     * @return <i>true</i> if successful. Otherwise <i>false</i> (<i>a</i> and
     *         <i>b</i> are already <br>
     *         in same set).
     */
    ...
    /**
     * Finds the root element of the set containing <i>x</i>, used as an unique
     * identifier for a set.<br>
